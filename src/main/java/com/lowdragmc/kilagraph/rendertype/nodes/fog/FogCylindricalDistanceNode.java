...
@NodeAttribute(name = "rt_fog_cylindrical_distance", group = "rendertype_fog", graphTypes = {RenderTypeGraph.class, ShaderFunctionGraph.class})
public class FogCylindricalDistanceNode extends ShaderNode {
    ...
    public void compile(ShaderCompileContext ctx) {
        ...
        ctx.output("out", new ShaderExpr("fog_cylindrical_distance(" + ctx.input("pos").code() + ")", GlslType.FLOAT));
    }
}
