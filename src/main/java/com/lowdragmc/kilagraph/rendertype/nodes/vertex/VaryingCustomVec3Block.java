...
@NodeAttribute(name = "rt_vertex_custom_vec3", group = "rendertype_vertex", graphTypes = RenderTypeGraph.class)
public class VaryingCustomVec3Block extends ShaderBlockNode implements IVaryingBlock {
    @Override
    protected Component getNodeTooltip() {
        return Component.translatable("kg.node.rt_vertex_custom_vec3.tooltip");
    }

    @Override
    public void onDefinePorts(IPortDefinitionContext context) {
        super.onDefinePorts(context);
        context.addInputPort("value", RenderTypeGraphTypes.VEC3);
        context.addOutputPort("value", RenderTypeGraphTypes.VEC3);
    }
