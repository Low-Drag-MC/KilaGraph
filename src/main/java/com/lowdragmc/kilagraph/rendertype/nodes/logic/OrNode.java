...
/** Unity's Or node: {@code out = a || b} (boolean). */
@NodeAttribute(name = "rt_or", group = "rendertype_logic", graphTypes = {RenderTypeGraph.class, ShaderFunctionGraph.class})
public class OrNode extends ShaderNode {
    @Override
