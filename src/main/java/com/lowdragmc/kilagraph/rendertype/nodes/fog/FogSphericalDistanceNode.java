...
/**
 * Vanilla's spherical fog distance of a position. {@link StageAffinity#VERTEX_ONLY}: fog distance is a
 ...
 */
@NodeAttribute(name = "rt_fog_spherical_distance", group = "rendertype_scene", graphTypes = {RenderTypeGraph.class, ShaderFunctionGraph.class})
public class FogSphericalDistanceNode extends ShaderNode {
    @Override
    protected Component getNodeTooltip() {
        return Component.translatable("kg.node.rt_fog_spherical_distance.tooltip");
    }
    ...
    public String glslExample() {
        return "out = fog_spherical_distance(pos);";
    }
}
