 ...
 * mesh's own {@code Normal} attribute flows through, byte-identical GLSL). Like the Position block,
 * a driven Normal is injectable into an Iris shaderpack's vertex shader.
 */
