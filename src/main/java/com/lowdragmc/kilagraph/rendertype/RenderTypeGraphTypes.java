...
public final class RenderTypeGraphTypes {
    ...
    public record CurveValue(List<ExplicitCubicBezierCurve2> segments, float lower, float upper) {
         ...
         * last key holds the last y, and a zero-width segment steps to its later point instead of
         * dividing by zero.
         */
    ...
    public static final Codec<ExplicitCubicBezierCurve2> CURVE_SEGMENT_CODEC = RecordCodecBuilder.create(i -> i.group(
            ExtraCodecs.VECTOR2F.fieldOf("p0").forGetter(c -> c.p0),
            ExtraCodecs.VECTOR2F.fieldOf("c0").forGetter(c -> c.c0),
            ExtraCodecs.VECTOR2F.fieldOf("c1").forGetter(c -> c.c1),
            ExtraCodecs.VECTOR2F.fieldOf("p1").forGetter(c -> c.p1)
