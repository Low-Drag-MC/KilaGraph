...
public final class RegistryProbeNodes {
    ...
    public static class EffectExists extends AnnotatedNode {
        ...
        public void evaluate(EvalContext ctx) {
            Identifier rl = id(ctx);
            MobEffect effect = rl == null ? null : BuiltInRegistries.MOB_EFFECT.getValue(rl);
    ...
    public static class AttributeExists extends AnnotatedNode {
        ...
        public void evaluate(EvalContext ctx) {
            Identifier rl = id(ctx);
            var attribute = rl == null ? null : BuiltInRegistries.ATTRIBUTE.getValue(rl);
    ...
    public static class EnchantmentExists extends AnnotatedNode {
        ...
        public void evaluate(EvalContext ctx) {
            ...
            var registry = l.registryAccess().lookupOrThrow(Registries.ENCHANTMENT);
            var enchantment = registry.getValue(rl);
    ...
    private static Identifier id(EvalContext ctx) {
        return ctx.getInput("id", Identifier.class, null);
    }
