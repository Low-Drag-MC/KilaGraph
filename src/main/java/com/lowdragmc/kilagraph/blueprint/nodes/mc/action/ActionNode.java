 ...
 * ({@link IThreadSafeNode#isThreadSafe()}) — rather than repeating it thirty-odd times and
 * discovering later that someone added one more without it. {@link McActions} already owns
 ...
 * node here — all of them carry one — but a pure node can write just as well: a value node
