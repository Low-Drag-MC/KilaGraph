...
@NodeAttribute(name = "math_divide", group = "math", graphTypes = BlueprintGraph.class)
public class DivideNode extends AnnotatedNode {
    @InputPort public float a = 0f;
    @InputPort public float b = 1f;
    @OutputPort public float out;

    @Override public Component getDisplayName() { return Component.literal("Divide"); }
