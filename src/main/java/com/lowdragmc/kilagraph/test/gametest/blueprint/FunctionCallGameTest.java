...
public final class FunctionCallGameTest {
    private static final String MULTIPLE_PARAMETERS_AND_RETURNS = "function_call_multiple_parameters_and_returns";
    private static final String TWO_CALL_SITES_DO_NOT_SHARE_STATE = "function_call_two_call_sites_do_not_share_state";
    private static final String THREE_LEVELS_DEEP = "function_call_three_levels_deep";
    private static final String FUNCTION_CONTAINING_A_LOOP = "function_call_function_containing_a_loop";
    private static final String LOOP_CONTAINING_A_FUNCTION_CALL = "function_call_loop_containing_a_function_call";
    ...
    public static void registerFunctions() {
        KGGameTests.registerFunction(MULTIPLE_PARAMETERS_AND_RETURNS, FunctionCallGameTest::multipleParametersAndReturns);
        KGGameTests.registerFunction(TWO_CALL_SITES_DO_NOT_SHARE_STATE, FunctionCallGameTest::twoCallSitesDoNotShareState);
        KGGameTests.registerFunction(THREE_LEVELS_DEEP, FunctionCallGameTest::threeLevelsDeep);
        KGGameTests.registerFunction(FUNCTION_CONTAINING_A_LOOP, FunctionCallGameTest::functionContainingALoop);
        KGGameTests.registerFunction(LOOP_CONTAINING_A_FUNCTION_CALL, FunctionCallGameTest::loopContainingAFunctionCall);
