...
public final class McStructureGameTest {
    private static final String BLOCK_STATE_BASICS = "mc_structure_block_state_basics";
    private static final String BLOCK_STATE_PROPERTIES_READ_AND_WRITE = "mc_structure_block_state_properties_read_and_write";
    private static final String BLOCK_STATE_ROTATE_AND_MIRROR = "mc_structure_block_state_rotate_and_mirror";
    private static final String ITEM_STACK_COUNT_AND_EQUALITY = "mc_structure_item_stack_count_and_equality";
    private static final String ITEM_STACK_COMPONENTS = "mc_structure_item_stack_components";
    private static final String FLUID_STACKS = "mc_structure_fluid_stacks";
    private static final String TEXT_NODES = "mc_structure_text_nodes";
    private static final String DATA_COMPONENTS_ROUND_TRIP = "mc_structure_data_components_round_trip";
    private static final String INSTANCE_OF_ANSWERS_WITHOUT_THROWING = "mc_structure_instance_of_answers_without_throwing";
    private static final String REGISTRY_PROBES = "mc_structure_registry_probes";

    public static void registerFunctions() {
        KGGameTests.registerFunction(BLOCK_STATE_BASICS, McStructureGameTest::blockStateBasics);
        KGGameTests.registerFunction(BLOCK_STATE_PROPERTIES_READ_AND_WRITE, McStructureGameTest::blockStatePropertiesReadAndWrite);
        KGGameTests.registerFunction(BLOCK_STATE_ROTATE_AND_MIRROR, McStructureGameTest::blockStateRotateAndMirror);
        KGGameTests.registerFunction(ITEM_STACK_COUNT_AND_EQUALITY, McStructureGameTest::itemStackCountAndEquality);
        KGGameTests.registerFunction(ITEM_STACK_COMPONENTS, McStructureGameTest::itemStackComponents);
        KGGameTests.registerFunction(FLUID_STACKS, McStructureGameTest::fluidStacks);
        KGGameTests.registerFunction(TEXT_NODES, McStructureGameTest::textNodes);
        KGGameTests.registerFunction(DATA_COMPONENTS_ROUND_TRIP, McStructureGameTest::dataComponentsRoundTrip);
        KGGameTests.registerFunction(INSTANCE_OF_ANSWERS_WITHOUT_THROWING, McStructureGameTest::instanceOfAnswersWithoutThrowing);
        KGGameTests.registerFunction(REGISTRY_PROBES, McStructureGameTest::registryProbes);
    }
    ...
    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        ...
        for (String p : new String[]{
                ...
                TEXT_NODES, DATA_COMPONENTS_ROUND_TRIP, INSTANCE_OF_ANSWERS_WITHOUT_THROWING,
                REGISTRY_PROBES
        }) {
    ...
    public static void itemStackCountAndEquality(GameTestHelper helper) {
        ...
        named.set(DataComponents.CUSTOM_NAME, Component.literal("Shiny"));
    ...
    public static void itemStackComponents(GameTestHelper helper) {
        ...
        assertEq(helper, "custom data round trips", 7, eval(get, "out", CompoundTag.class).getIntOr("charge", 0));

        // the input must not have been mutated — every node here copies
        assertTrue(helper, "setting custom data did not touch the input",
                plain.get(DataComponents.CUSTOM_DATA) == null);
    ...
    public static void dataComponentsRoundTrip(GameTestHelper helper) {
        ...
        Identifier damage = id("minecraft:damage");
        ...
        assertEq(helper, "and the game agrees it is damaged", 7,
                damaged.getOrDefault(DataComponents.DAMAGE, 0).intValue());
        ...
        assertEq(helper, "and round trips through the value wrapper", 7,
                eval(getDamage, "nbt", CompoundTag.class).getIntOr(DataComponentNodes.VALUE_KEY, 0));
        ...
        assertEq(helper, "and yields the same value", 7,
                eval(again, "out", ItemStack.class).getOrDefault(DataComponents.DAMAGE, 0).intValue());
    ...
    /** Is Type over a wired-in {@code Identifier}, against {@code target}. */
    ...
    public static void registryProbes(GameTestHelper helper) {
        ...
        var attribute = node(RegistryProbeNodes.AttributeExists.class,
                "id", id("minecraft:movement_speed"));
