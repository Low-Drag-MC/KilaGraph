...
public final class VectorNodeGameTest {
    private static final String MAKE_AND_BREAK_ROUND_TRIP_EVERY_WIDTH = "vector_node_make_and_break_round_trip_every_width";
    private static final String COMPONENT_WISE_OPERATIONS_KEEP_EVERY_COMPONENT = "vector_node_component_wise_operations_keep_every_component";
    private static final String REDUCING_OPERATIONS_SUM_OVER_EVERY_COMPONENT = "vector_node_reducing_operations_sum_over_every_component";
    private static final String NORMALIZE_OF_ZERO_IS_ZERO_NOT_NA_N = "vector_node_normalize_of_zero_is_zero_not_na_n";
    private static final String CROSS_FOLLOWS_THE_RIGHT_HAND_RULE = "vector_node_cross_follows_the_right_hand_rule";
    private static final String FLATTEN_DROPS_THE_CHOSEN_AXIS_ONLY = "vector_node_flatten_drops_the_chosen_axis_only";
    private static final String YAW_BETWEEN_IS_SIGNED_AND_FOLDED = "vector_node_yaw_between_is_signed_and_folded";
    private static final String MISMATCHED_WIDTHS_TAKE_THE_WIDER_AND_ZERO_FILL = "vector_node_mismatched_widths_take_the_wider_and_zero_fill";
    private static final String LERP_CLAMPS_T_TO_THE_UNIT_RANGE = "vector_node_lerp_clamps_t_to_the_unit_range";
    private static final String CROSS_READS_THE_FIRST_THREE_OF_ANY_WIDTH = "vector_node_cross_reads_the_first_three_of_any_width";
    private static final String FLATTEN_IGNORES_AN_AXIS_THE_INPUT_DOES_NOT_HAVE = "vector_node_flatten_ignores_an_axis_the_input_does_not_have";
    private static final String YAW_IGNORES_THE_VERTICAL_COMPONENT = "vector_node_yaw_ignores_the_vertical_component";
    private static final String MAKE_DEFAULTS_TO_ZERO_AND_MAKE2_STAYS_WIDTH_TWO = "vector_node_make_defaults_to_zero_and_make2_stays_width_two";

    public static void registerFunctions() {
        KGGameTests.registerFunction(MAKE_AND_BREAK_ROUND_TRIP_EVERY_WIDTH, VectorNodeGameTest::makeAndBreakRoundTripEveryWidth);
        KGGameTests.registerFunction(COMPONENT_WISE_OPERATIONS_KEEP_EVERY_COMPONENT, VectorNodeGameTest::componentWiseOperationsKeepEveryComponent);
        KGGameTests.registerFunction(REDUCING_OPERATIONS_SUM_OVER_EVERY_COMPONENT, VectorNodeGameTest::reducingOperationsSumOverEveryComponent);
        KGGameTests.registerFunction(NORMALIZE_OF_ZERO_IS_ZERO_NOT_NA_N, VectorNodeGameTest::normalizeOfZeroIsZeroNotNaN);
        KGGameTests.registerFunction(CROSS_FOLLOWS_THE_RIGHT_HAND_RULE, VectorNodeGameTest::crossFollowsTheRightHandRule);
        KGGameTests.registerFunction(FLATTEN_DROPS_THE_CHOSEN_AXIS_ONLY, VectorNodeGameTest::flattenDropsTheChosenAxisOnly);
        KGGameTests.registerFunction(YAW_BETWEEN_IS_SIGNED_AND_FOLDED, VectorNodeGameTest::yawBetweenIsSignedAndFolded);
        KGGameTests.registerFunction(MISMATCHED_WIDTHS_TAKE_THE_WIDER_AND_ZERO_FILL, VectorNodeGameTest::mismatchedWidthsTakeTheWiderAndZeroFill);
        KGGameTests.registerFunction(LERP_CLAMPS_T_TO_THE_UNIT_RANGE, VectorNodeGameTest::lerpClampsTToTheUnitRange);
        KGGameTests.registerFunction(CROSS_READS_THE_FIRST_THREE_OF_ANY_WIDTH, VectorNodeGameTest::crossReadsTheFirstThreeOfAnyWidth);
        KGGameTests.registerFunction(FLATTEN_IGNORES_AN_AXIS_THE_INPUT_DOES_NOT_HAVE, VectorNodeGameTest::flattenIgnoresAnAxisTheInputDoesNotHave);
        KGGameTests.registerFunction(YAW_IGNORES_THE_VERTICAL_COMPONENT, VectorNodeGameTest::yawIgnoresTheVerticalComponent);
        KGGameTests.registerFunction(MAKE_DEFAULTS_TO_ZERO_AND_MAKE2_STAYS_WIDTH_TWO, VectorNodeGameTest::makeDefaultsToZeroAndMake2StaysWidthTwo);
    }
    ...
    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        ...
        for (String p : new String[]{
                ...
                YAW_BETWEEN_IS_SIGNED_AND_FOLDED, MISMATCHED_WIDTHS_TAKE_THE_WIDER_AND_ZERO_FILL, LERP_CLAMPS_T_TO_THE_UNIT_RANGE,
                CROSS_READS_THE_FIRST_THREE_OF_ANY_WIDTH, FLATTEN_IGNORES_AN_AXIS_THE_INPUT_DOES_NOT_HAVE, YAW_IGNORES_THE_VERTICAL_COMPONENT,
                MAKE_DEFAULTS_TO_ZERO_AND_MAKE2_STAYS_WIDTH_TWO
        }) {
