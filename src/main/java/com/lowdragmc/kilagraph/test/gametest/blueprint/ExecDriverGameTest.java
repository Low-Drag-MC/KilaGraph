...
public final class ExecDriverGameTest {
    private static final String BOTH_DRIVERS_RUN_THE_SAME_NODES = "exec_driver_both_drivers_run_the_same_nodes";

    private ExecDriverGameTest() {}


    public static void registerFunctions() {
        KGGameTests.registerFunction(BOTH_DRIVERS_RUN_THE_SAME_NODES, ExecDriverGameTest::bothDriversRunTheSameNodes);
    }
