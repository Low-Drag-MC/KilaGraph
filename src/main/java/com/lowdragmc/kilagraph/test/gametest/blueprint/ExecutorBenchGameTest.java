...
public final class ExecutorBenchGameTest {
    private static final String LERP_CHAIN16 = "executor_bench_lerp_chain16";
    private static final String ADD_CHAIN16 = "executor_bench_add_chain16";
    private static final String LOCOMOTION = "executor_bench_locomotion";
    private static final String COST_BREAKDOWN = "executor_bench_cost_breakdown";

    private ExecutorBenchGameTest() {}


    public static void registerFunctions() {
        KGGameTests.registerFunction(LERP_CHAIN16, ExecutorBenchGameTest::lerpChain16);
        KGGameTests.registerFunction(ADD_CHAIN16, ExecutorBenchGameTest::addChain16);
        KGGameTests.registerFunction(LOCOMOTION, ExecutorBenchGameTest::locomotion);
        KGGameTests.registerFunction(COST_BREAKDOWN, ExecutorBenchGameTest::costBreakdown);
    }
