...
public final class McGeometryGameTest {
    private static final String BLOCK_POS_ARITHMETIC = "mc_geometry_block_pos_arithmetic";
    private static final String BLOCK_POS_VECTOR_CONVERSIONS_RESPECT_THE_CENTRE_OPTION = "mc_geometry_block_pos_vector_conversions_respect_the_centre_option";
    private static final String BETWEEN_ENUMERATES_AND_REPORTS_TRUNCATION = "mc_geometry_between_enumerates_and_reports_truncation";
    private static final String BOUNDING_BOXES = "mc_geometry_bounding_boxes";
    private static final String BOUNDING_BOX_RELATIONS = "mc_geometry_bounding_box_relations";
    private static final String CHUNK_COORDINATES = "mc_geometry_chunk_coordinates";
    private static final String DIRECTION_MATHS = "mc_geometry_direction_maths";
    private static final String DIRECTION_OPPOSITE_AXIS_AND_OFFSET = "mc_geometry_direction_opposite_axis_and_offset";

    public static void registerFunctions() {
        KGGameTests.registerFunction(BLOCK_POS_ARITHMETIC, McGeometryGameTest::blockPosArithmetic);
        KGGameTests.registerFunction(BLOCK_POS_VECTOR_CONVERSIONS_RESPECT_THE_CENTRE_OPTION, McGeometryGameTest::blockPosVectorConversionsRespectTheCentreOption);
        KGGameTests.registerFunction(BETWEEN_ENUMERATES_AND_REPORTS_TRUNCATION, McGeometryGameTest::betweenEnumeratesAndReportsTruncation);
        KGGameTests.registerFunction(BOUNDING_BOXES, McGeometryGameTest::boundingBoxes);
        KGGameTests.registerFunction(BOUNDING_BOX_RELATIONS, McGeometryGameTest::boundingBoxRelations);
        KGGameTests.registerFunction(CHUNK_COORDINATES, McGeometryGameTest::chunkCoordinates);
        KGGameTests.registerFunction(DIRECTION_MATHS, McGeometryGameTest::directionMaths);
        KGGameTests.registerFunction(DIRECTION_OPPOSITE_AXIS_AND_OFFSET, McGeometryGameTest::directionOppositeAxisAndOffset);
    }
    ...
    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        ...
        for (String p : new String[]{
                ...
                DIRECTION_MATHS, DIRECTION_OPPOSITE_AXIS_AND_OFFSET
        }) {
