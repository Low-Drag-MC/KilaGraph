...
public final class McIdTagGameTest {
    private static final String IDS_ARE_BUILT_AND_PARSED = "mc_id_tag_ids_are_built_and_parsed";
    private static final String REGISTRY_LOOKUPS_ROUND_TRIP = "mc_id_tag_registry_lookups_round_trip";
    private static final String UNKNOWN_IDS_ARE_NOT_SILENTLY_DEFAULTED = "mc_id_tag_unknown_ids_are_not_silently_defaulted";
    private static final String TAG_MEMBERSHIP_IS_TESTED_PER_REGISTRY = "mc_id_tag_tag_membership_is_tested_per_registry";
    private static final String TAG_CONTENTS_ARE_LISTED_PER_REGISTRY = "mc_id_tag_tag_contents_are_listed_per_registry";

    public static void registerFunctions() {
        KGGameTests.registerFunction(IDS_ARE_BUILT_AND_PARSED, McIdTagGameTest::idsAreBuiltAndParsed);
        KGGameTests.registerFunction(REGISTRY_LOOKUPS_ROUND_TRIP, McIdTagGameTest::registryLookupsRoundTrip);
        KGGameTests.registerFunction(UNKNOWN_IDS_ARE_NOT_SILENTLY_DEFAULTED, McIdTagGameTest::unknownIdsAreNotSilentlyDefaulted);
        KGGameTests.registerFunction(TAG_MEMBERSHIP_IS_TESTED_PER_REGISTRY, McIdTagGameTest::tagMembershipIsTestedPerRegistry);
        KGGameTests.registerFunction(TAG_CONTENTS_ARE_LISTED_PER_REGISTRY, McIdTagGameTest::tagContentsAreListedPerRegistry);
    }
    ...
    public static void idsAreBuiltAndParsed(GameTestHelper helper) {
        ...
        assertEq(helper, "create", Identifier.fromNamespaceAndPath("minecraft", "diamond"),
                eval(create, "out", Identifier.class));
        ...
        assertEq(helper, "malformed namespace gives null", null, eval(bad, "out", Identifier.class));

        var parse = node(McIdNodes.Parse.class, "in", "minecraft:diamond_sword");
        assertEq(helper, "parse", Identifier.fromNamespaceAndPath("minecraft", "diamond_sword"),
                eval(parse, "out", Identifier.class));
        ...
        assertEq(helper, "bare path takes the minecraft namespace",
                ...
                eval(bare, "out", Identifier.class));
    ...
    public static void unknownIdsAreNotSilentlyDefaulted(GameTestHelper helper) {
        for (var cls : List.of(McIdNodes.ItemFromId.class, McIdNodes.BlockFromId.class,
            ...
            var n = node(cls, "id", Identifier.fromNamespaceAndPath("kilagraph", "no_such_thing"));
    ...
    private static void assertRoundTrip(GameTestHelper helper, String label,
        ...
        assertEq(helper, label + " back to id", id(idText), eval(to, "out", Identifier.class));
    }
