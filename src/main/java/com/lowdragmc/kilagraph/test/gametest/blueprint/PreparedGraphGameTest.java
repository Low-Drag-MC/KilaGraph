...
public final class PreparedGraphGameTest {
    private static final String CYCLE_IS_DETECTED = "prepared_graph_cycle_is_detected";
    private static final String A_LEAKED_VISITING_STACK_WOULD_RESURFACE_ON_AN_UNRELATED_BRANCH = "prepared_graph_a_leaked_visiting_stack_would_resurface_on_an_unrelated_branch";
    private static final String SELF_CYCLE_IS_DETECTED = "prepared_graph_self_cycle_is_detected";
    private static final String PORT_SET_GROWTH_IS_NOTICED = "prepared_graph_port_set_growth_is_noticed";
    private static final String REWIRING_IS_NOTICED = "prepared_graph_rewiring_is_noticed";
    private static final String ADMITTING_A_NODE_DOES_NOT_LAUNDER_AN_EDIT = "prepared_graph_admitting_a_node_does_not_launder_an_edit";
    private static final String OVERSIZED_FLOAT_NARROWS_LIKE_NUMBER_INT_VALUE = "prepared_graph_oversized_float_narrows_like_number_int_value";
    private static final String NUMERIC_LANE_ROUND_TRIPS_THROUGH_THE_OBJECT_LANE = "prepared_graph_numeric_lane_round_trips_through_the_object_lane";
    private static final String LARGE_LONG_ROUNDS_ONCE_INTO_FLOAT = "prepared_graph_large_long_rounds_once_into_float";
    private static final String CYCLE_THROUGH_A_WIRE_PORTAL_IS_STILL_DETECTED = "prepared_graph_cycle_through_a_wire_portal_is_still_detected";

    private PreparedGraphGameTest() {}


    public static void registerFunctions() {
        KGGameTests.registerFunction(CYCLE_IS_DETECTED, PreparedGraphGameTest::cycleIsDetected);
        KGGameTests.registerFunction(A_LEAKED_VISITING_STACK_WOULD_RESURFACE_ON_AN_UNRELATED_BRANCH, PreparedGraphGameTest::aLeakedVisitingStackWouldResurfaceOnAnUnrelatedBranch);
        KGGameTests.registerFunction(SELF_CYCLE_IS_DETECTED, PreparedGraphGameTest::selfCycleIsDetected);
        KGGameTests.registerFunction(PORT_SET_GROWTH_IS_NOTICED, PreparedGraphGameTest::portSetGrowthIsNoticed);
        KGGameTests.registerFunction(REWIRING_IS_NOTICED, PreparedGraphGameTest::rewiringIsNoticed);
        KGGameTests.registerFunction(ADMITTING_A_NODE_DOES_NOT_LAUNDER_AN_EDIT, PreparedGraphGameTest::admittingANodeDoesNotLaunderAnEdit);
        KGGameTests.registerFunction(OVERSIZED_FLOAT_NARROWS_LIKE_NUMBER_INT_VALUE, PreparedGraphGameTest::oversizedFloatNarrowsLikeNumberIntValue);
        KGGameTests.registerFunction(NUMERIC_LANE_ROUND_TRIPS_THROUGH_THE_OBJECT_LANE, PreparedGraphGameTest::numericLaneRoundTripsThroughTheObjectLane);
        KGGameTests.registerFunction(LARGE_LONG_ROUNDS_ONCE_INTO_FLOAT, PreparedGraphGameTest::largeLongRoundsOnceIntoFloat);
        KGGameTests.registerFunction(CYCLE_THROUGH_A_WIRE_PORTAL_IS_STILL_DETECTED, PreparedGraphGameTest::cycleThroughAWirePortalIsStillDetected);
    }
    ...
    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        ...
        for (String p : new String[]{
                ...
                OVERSIZED_FLOAT_NARROWS_LIKE_NUMBER_INT_VALUE, NUMERIC_LANE_ROUND_TRIPS_THROUGH_THE_OBJECT_LANE, LARGE_LONG_ROUNDS_ONCE_INTO_FLOAT,
                CYCLE_THROUGH_A_WIRE_PORTAL_IS_STILL_DETECTED
        }) {
