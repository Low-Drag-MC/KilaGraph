...
public final class McPotionGameTest {
    private static final String POTIONS_ARE_BUILT_AND_READ = "mc_potion_potions_are_built_and_read";
    private static final String CUSTOM_EFFECTS_STACK_ON_THE_BASE = "mc_potion_custom_effects_stack_on_the_base";
    private static final String EFFECTS_ARE_REMOVED = "mc_potion_effects_are_removed";

    public static void registerFunctions() {
        KGGameTests.registerFunction(POTIONS_ARE_BUILT_AND_READ, McPotionGameTest::potionsAreBuiltAndRead);
        KGGameTests.registerFunction(CUSTOM_EFFECTS_STACK_ON_THE_BASE, McPotionGameTest::customEffectsStackOnTheBase);
        KGGameTests.registerFunction(EFFECTS_ARE_REMOVED, McPotionGameTest::effectsAreRemoved);
    }
    ...
    private static final Identifier SWIFTNESS = Identifier.parse("minecraft:swiftness");
    private static final Identifier STRONG_SWIFTNESS = Identifier.parse("minecraft:strong_swiftness");
    private static final Identifier SPEED = Identifier.parse("minecraft:speed");
    private static final Identifier STRENGTH = Identifier.parse("minecraft:strength");
    ...
    public static void potionsAreBuiltAndRead(GameTestHelper helper) {
        ...
        assertEq(helper, "and it is swiftness", SWIFTNESS, eval(type, "out", Identifier.class));
    ...
    public static void customEffectsStackOnTheBase(GameTestHelper helper) {
        ...
        assertEq(helper, "still swiftness underneath", SWIFTNESS,
                eval(node(PotionNodes.Type.class, "stack", mixed), "out", Identifier.class));
    ...
    public static void effectsAreRemoved(GameTestHelper helper) {
        ...
        assertTrue(helper, "and it really has it", pig.hasEffect(MobEffects.SPEED));
        ...
        assertFalse(helper, "and the effect is gone", pig.hasEffect(MobEffects.SPEED));
