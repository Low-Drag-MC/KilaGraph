...
public final class DeterminismGameTest {
    private static final String A_SEEDED_RUN_IS_REPRODUCIBLE = "determinism_a_seeded_run_is_reproducible";
    private static final String ADIFFERENT_SEED_PRODUCES_DIFFERENT_DRAWS = "determinism_adifferent_seed_produces_different_draws";
    private static final String REPEATED_RUNS_AGREE_EXACTLY = "determinism_repeated_runs_agree_exactly";
    private static final String INTERLEAVED_EXECUTORS_DO_NOT_INTERFERE = "determinism_interleaved_executors_do_not_interfere";

    private DeterminismGameTest() {}


    public static void registerFunctions() {
        KGGameTests.registerFunction(A_SEEDED_RUN_IS_REPRODUCIBLE, DeterminismGameTest::aSeededRunIsReproducible);
        KGGameTests.registerFunction(ADIFFERENT_SEED_PRODUCES_DIFFERENT_DRAWS, DeterminismGameTest::adifferentSeedProducesDifferentDraws);
        KGGameTests.registerFunction(REPEATED_RUNS_AGREE_EXACTLY, DeterminismGameTest::repeatedRunsAgreeExactly);
        KGGameTests.registerFunction(INTERLEAVED_EXECUTORS_DO_NOT_INTERFERE, DeterminismGameTest::interleavedExecutorsDoNotInterfere);
    }
