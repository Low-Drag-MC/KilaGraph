...
public final class McIntegrationGameTest {
    private static final String BUILDS_A_COLUMN = "mc_integration_builds_a_column";
    private static final String DAMAGES_ONLY_THE_MATCHING_ENTITIES = "mc_integration_damages_only_the_matching_entities";
    private static final String FILLS_ONLY_THE_AIR_IN_A_REGION = "mc_integration_fills_only_the_air_in_a_region";
    private static final String ITEM_COMPONENTS_SURVIVE_INTO_THE_WORLD = "mc_integration_item_components_survive_into_the_world";
    private static final String COMMAND_OUTPUT_IS_PARSED_BACK_INTO_A_NUMBER = "mc_integration_command_output_is_parsed_back_into_a_number";
    private static final String A_TAGS_CONTENTS_ARE_MEMBERS_OF_THAT_SAME_TAG = "mc_integration_a_tags_contents_are_members_of_that_same_tag";
    private static final String A_FOUND_RECIPE_ID_LOOKS_UP_ITS_OWN_RESULT = "mc_integration_a_found_recipe_id_looks_up_its_own_result";
    private static final String NBT_FLOWS_THROUGH_A_PATH_WRITE_AND_BACK = "mc_integration_nbt_flows_through_a_path_write_and_back";
    private static final String A_POTION_IS_BUILT_AND_READ_BACK_THROUGH_THE_GRAPH = "mc_integration_a_potion_is_built_and_read_back_through_the_graph";
    private static final String ONE_BLOCK_POSITION_DRIVES_THE_WHOLE_MINING_DECISION = "mc_integration_one_block_position_drives_the_whole_mining_decision";
    private static final String AN_EFFECT_FLOW_RUNS_IN_ORDER_OVER_ONE_ENTITY = "mc_integration_an_effect_flow_runs_in_order_over_one_entity";

    public static void registerFunctions() {
        KGGameTests.registerFunction(BUILDS_A_COLUMN, McIntegrationGameTest::buildsAColumn);
        KGGameTests.registerFunction(DAMAGES_ONLY_THE_MATCHING_ENTITIES, McIntegrationGameTest::damagesOnlyTheMatchingEntities);
        KGGameTests.registerFunction(FILLS_ONLY_THE_AIR_IN_A_REGION, McIntegrationGameTest::fillsOnlyTheAirInARegion);
        KGGameTests.registerFunction(ITEM_COMPONENTS_SURVIVE_INTO_THE_WORLD, McIntegrationGameTest::itemComponentsSurviveIntoTheWorld);
        KGGameTests.registerFunction(COMMAND_OUTPUT_IS_PARSED_BACK_INTO_A_NUMBER, McIntegrationGameTest::commandOutputIsParsedBackIntoANumber);
        KGGameTests.registerFunction(A_TAGS_CONTENTS_ARE_MEMBERS_OF_THAT_SAME_TAG, McIntegrationGameTest::aTagsContentsAreMembersOfThatSameTag);
        KGGameTests.registerFunction(A_FOUND_RECIPE_ID_LOOKS_UP_ITS_OWN_RESULT, McIntegrationGameTest::aFoundRecipeIdLooksUpItsOwnResult);
        KGGameTests.registerFunction(NBT_FLOWS_THROUGH_A_PATH_WRITE_AND_BACK, McIntegrationGameTest::nbtFlowsThroughAPathWriteAndBack);
        KGGameTests.registerFunction(A_POTION_IS_BUILT_AND_READ_BACK_THROUGH_THE_GRAPH, McIntegrationGameTest::aPotionIsBuiltAndReadBackThroughTheGraph);
        KGGameTests.registerFunction(ONE_BLOCK_POSITION_DRIVES_THE_WHOLE_MINING_DECISION, McIntegrationGameTest::oneBlockPositionDrivesTheWholeMiningDecision);
        KGGameTests.registerFunction(AN_EFFECT_FLOW_RUNS_IN_ORDER_OVER_ONE_ENTITY, McIntegrationGameTest::anEffectFlowRunsInOrderOverOneEntity);
    }
    ...
    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        ...
        for (String p : new String[]{
                ...
                A_FOUND_RECIPE_ID_LOOKS_UP_ITS_OWN_RESULT, NBT_FLOWS_THROUGH_A_PATH_WRITE_AND_BACK, A_POTION_IS_BUILT_AND_READ_BACK_THROUGH_THE_GRAPH,
                ONE_BLOCK_POSITION_DRIVES_THE_WHOLE_MINING_DECISION, AN_EFFECT_FLOW_RUNS_IN_ORDER_OVER_ONE_ENTITY
        }) {
    ...
    public static void commandOutputIsParsedBackIntoANumber(GameTestHelper helper) {
        ...
        setInputConstant(command, "command", "time query gametime");
        ...
        assertEq(helper, "and that is really the world's game time",
                (int) (level.getGameTime() % 2147483647L), fromResult);
        helper.succeed();
    }
    ...
    public static void nbtFlowsThroughAPathWriteAndBack(GameTestHelper helper) {
        ...
        assertEq(helper, "and holds the leaf", "Excalibur",
                exec.evaluate(parent.getOutputsById().get("out"), CompoundTag.class).getStringOr("Name", ""));
        helper.succeed();
    }
    ...
    public static void anEffectFlowRunsInOrderOverOneEntity(GameTestHelper helper) {
        ...
        setInputConstant(speed, "effect", Identifier.parse("minecraft:speed"));
        setInputConstant(speed, "duration", 200);
        setInputConstant(strength, "effect", Identifier.parse("minecraft:strength"));
