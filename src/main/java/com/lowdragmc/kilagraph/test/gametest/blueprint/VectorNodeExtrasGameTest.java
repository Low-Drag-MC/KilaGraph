...
public final class VectorNodeExtrasGameTest {
    private static final String SWIZZLE_WIDTH = "vector_extras_swizzle_width";
    private static final String SWIZZLE_REFUSES_BAD_MASK = "vector_extras_swizzle_refuses_bad_mask";
    private static final String CONCAT = "vector_extras_concat";
    private static final String APPEND = "vector_extras_append";
    private static final String SET_COMPONENT = "vector_extras_set_component";
    private static final String GET_COMPONENT = "vector_extras_get_component";
    private static final String MULTIPLY_DIVIDE = "vector_extras_multiply_divide";
    private static final String NEGATE_ABS_MIN_MAX = "vector_extras_negate_abs_min_max";
    private static final String CLAMP = "vector_extras_clamp";
    private static final String ROUNDING_MODES = "vector_extras_rounding_modes";
    private static final String SQUARED_FORMS = "vector_extras_squared_forms";
    private static final String CLAMP_LENGTH = "vector_extras_clamp_length";
    private static final String PROJECT_REJECT = "vector_extras_project_reject";
    private static final String REFLECT = "vector_extras_reflect";
    private static final String ANGLE_BETWEEN = "vector_extras_angle_between";
    private static final String ROTATE_ABOUT_AXIS = "vector_extras_rotate_about_axis";
    ...
    public static void registerFunctions() {
        ...
        KGGameTests.registerFunction(SWIZZLE_REFUSES_BAD_MASK, VectorNodeExtrasGameTest::swizzleRefusesMasksItCannotHonour);
        KGGameTests.registerFunction(CONCAT, VectorNodeExtrasGameTest::concatJoinsInOrderAndStopsAtFour);
        KGGameTests.registerFunction(APPEND, VectorNodeExtrasGameTest::appendWidensByOneAndStopsAtFour);
        KGGameTests.registerFunction(SET_COMPONENT, VectorNodeExtrasGameTest::setComponentKeepsTheInputWidth);
        KGGameTests.registerFunction(GET_COMPONENT, VectorNodeExtrasGameTest::getComponentReadsByIndexAndZeroesOutOfRange);
        KGGameTests.registerFunction(MULTIPLY_DIVIDE, VectorNodeExtrasGameTest::multiplyAndDivideActPerComponent);
        KGGameTests.registerFunction(NEGATE_ABS_MIN_MAX, VectorNodeExtrasGameTest::negateAbsMinAndMaxActPerComponent);
        KGGameTests.registerFunction(CLAMP, VectorNodeExtrasGameTest::clampHoldsEveryComponentBetweenTheBounds);
        KGGameTests.registerFunction(ROUNDING_MODES, VectorNodeExtrasGameTest::everyRoundingModeDiffers);
        KGGameTests.registerFunction(SQUARED_FORMS, VectorNodeExtrasGameTest::squaredFormsCountEveryComponent);
        KGGameTests.registerFunction(CLAMP_LENGTH, VectorNodeExtrasGameTest::clampLengthRescalesWithoutTurning);
        KGGameTests.registerFunction(PROJECT_REJECT, VectorNodeExtrasGameTest::projectAndRejectSplitTheVector);
        KGGameTests.registerFunction(REFLECT, VectorNodeExtrasGameTest::reflectMirrorsAboutTheNormal);
        KGGameTests.registerFunction(ANGLE_BETWEEN, VectorNodeExtrasGameTest::angleBetweenIsUnsignedAndSafeAtTheEnds);
        KGGameTests.registerFunction(ROTATE_ABOUT_AXIS, VectorNodeExtrasGameTest::rotateAboutAxisIsRightHanded);
    ...
    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        ...
        KGGameTests.registerFunctionTest(event, APPEND, KGGameTests.functionKey(APPEND), data);
        KGGameTests.registerFunctionTest(event, SET_COMPONENT, KGGameTests.functionKey(SET_COMPONENT), data);
        KGGameTests.registerFunctionTest(event, GET_COMPONENT, KGGameTests.functionKey(GET_COMPONENT), data);
        KGGameTests.registerFunctionTest(event, MULTIPLY_DIVIDE, KGGameTests.functionKey(MULTIPLY_DIVIDE), data);
        KGGameTests.registerFunctionTest(event, NEGATE_ABS_MIN_MAX, KGGameTests.functionKey(NEGATE_ABS_MIN_MAX), data);
        KGGameTests.registerFunctionTest(event, CLAMP, KGGameTests.functionKey(CLAMP), data);
        KGGameTests.registerFunctionTest(event, ROUNDING_MODES, KGGameTests.functionKey(ROUNDING_MODES), data);
        KGGameTests.registerFunctionTest(event, SQUARED_FORMS, KGGameTests.functionKey(SQUARED_FORMS), data);
        KGGameTests.registerFunctionTest(event, CLAMP_LENGTH, KGGameTests.functionKey(CLAMP_LENGTH), data);
        KGGameTests.registerFunctionTest(event, PROJECT_REJECT, KGGameTests.functionKey(PROJECT_REJECT), data);
        KGGameTests.registerFunctionTest(event, REFLECT, KGGameTests.functionKey(REFLECT), data);
        KGGameTests.registerFunctionTest(event, ANGLE_BETWEEN, KGGameTests.functionKey(ANGLE_BETWEEN), data);
        KGGameTests.registerFunctionTest(event, ROTATE_ABOUT_AXIS, KGGameTests.functionKey(ROTATE_ABOUT_AXIS), data);
