...
public final class VectorNodeExtrasGameTest {
    private static final String SWIZZLE_MASK_DECIDES_THE_OUTPUT_WIDTH = "vector_extras_swizzle_mask_decides_the_output_width";
    private static final String SWIZZLE_REFUSES_MASKS_IT_CANNOT_HONOUR = "vector_extras_swizzle_refuses_masks_it_cannot_honour";
    private static final String CONCAT_JOINS_IN_ORDER_AND_STOPS_AT_FOUR = "vector_extras_concat_joins_in_order_and_stops_at_four";
    private static final String APPEND_WIDENS_BY_ONE_AND_STOPS_AT_FOUR = "vector_extras_append_widens_by_one_and_stops_at_four";
    private static final String SET_COMPONENT_KEEPS_THE_INPUT_WIDTH = "vector_extras_set_component_keeps_the_input_width";
    private static final String GET_COMPONENT_READS_BY_INDEX_AND_ZEROES_OUT_OF_RANGE = "vector_extras_get_component_reads_by_index_and_zeroes_out_of_range";
    private static final String MULTIPLY_AND_DIVIDE_ACT_PER_COMPONENT = "vector_extras_multiply_and_divide_act_per_component";
    private static final String NEGATE_ABS_MIN_AND_MAX_ACT_PER_COMPONENT = "vector_extras_negate_abs_min_and_max_act_per_component";
    private static final String CLAMP_HOLDS_EVERY_COMPONENT_BETWEEN_THE_BOUNDS = "vector_extras_clamp_holds_every_component_between_the_bounds";
    private static final String EVERY_ROUNDING_MODE_DIFFERS = "vector_extras_every_rounding_mode_differs";
    private static final String SQUARED_FORMS_COUNT_EVERY_COMPONENT = "vector_extras_squared_forms_count_every_component";
    private static final String CLAMP_LENGTH_RESCALES_WITHOUT_TURNING = "vector_extras_clamp_length_rescales_without_turning";
    private static final String PROJECT_AND_REJECT_SPLIT_THE_VECTOR = "vector_extras_project_and_reject_split_the_vector";
    private static final String REFLECT_MIRRORS_ABOUT_THE_NORMAL = "vector_extras_reflect_mirrors_about_the_normal";
    private static final String ANGLE_BETWEEN_IS_UNSIGNED_AND_SAFE_AT_THE_ENDS = "vector_extras_angle_between_is_unsigned_and_safe_at_the_ends";
    private static final String ROTATE_ABOUT_AXIS_IS_RIGHT_HANDED = "vector_extras_rotate_about_axis_is_right_handed";
    private static final String ROTATION_AND_DIRECTION_AGREE_WITH_THE_GAME = "vector_extras_rotation_and_direction_agree_with_the_game";
    private static final String MOVE_TOWARDS_LANDS_EXACTLY_ON_THE_TARGET = "vector_extras_move_towards_lands_exactly_on_the_target";
    private static final String NEARLY_EQUALS_COMPARES_OVER_THE_WIDER_WIDTH = "vector_extras_nearly_equals_compares_over_the_wider_width";

    public static void registerFunctions() {
        KGGameTests.registerFunction(SWIZZLE_MASK_DECIDES_THE_OUTPUT_WIDTH, VectorNodeExtrasGameTest::swizzleMaskDecidesTheOutputWidth);
        KGGameTests.registerFunction(SWIZZLE_REFUSES_MASKS_IT_CANNOT_HONOUR, VectorNodeExtrasGameTest::swizzleRefusesMasksItCannotHonour);
        KGGameTests.registerFunction(CONCAT_JOINS_IN_ORDER_AND_STOPS_AT_FOUR, VectorNodeExtrasGameTest::concatJoinsInOrderAndStopsAtFour);
        KGGameTests.registerFunction(APPEND_WIDENS_BY_ONE_AND_STOPS_AT_FOUR, VectorNodeExtrasGameTest::appendWidensByOneAndStopsAtFour);
        KGGameTests.registerFunction(SET_COMPONENT_KEEPS_THE_INPUT_WIDTH, VectorNodeExtrasGameTest::setComponentKeepsTheInputWidth);
        KGGameTests.registerFunction(GET_COMPONENT_READS_BY_INDEX_AND_ZEROES_OUT_OF_RANGE, VectorNodeExtrasGameTest::getComponentReadsByIndexAndZeroesOutOfRange);
        KGGameTests.registerFunction(MULTIPLY_AND_DIVIDE_ACT_PER_COMPONENT, VectorNodeExtrasGameTest::multiplyAndDivideActPerComponent);
        KGGameTests.registerFunction(NEGATE_ABS_MIN_AND_MAX_ACT_PER_COMPONENT, VectorNodeExtrasGameTest::negateAbsMinAndMaxActPerComponent);
        KGGameTests.registerFunction(CLAMP_HOLDS_EVERY_COMPONENT_BETWEEN_THE_BOUNDS, VectorNodeExtrasGameTest::clampHoldsEveryComponentBetweenTheBounds);
        KGGameTests.registerFunction(EVERY_ROUNDING_MODE_DIFFERS, VectorNodeExtrasGameTest::everyRoundingModeDiffers);
        KGGameTests.registerFunction(SQUARED_FORMS_COUNT_EVERY_COMPONENT, VectorNodeExtrasGameTest::squaredFormsCountEveryComponent);
        KGGameTests.registerFunction(CLAMP_LENGTH_RESCALES_WITHOUT_TURNING, VectorNodeExtrasGameTest::clampLengthRescalesWithoutTurning);
        KGGameTests.registerFunction(PROJECT_AND_REJECT_SPLIT_THE_VECTOR, VectorNodeExtrasGameTest::projectAndRejectSplitTheVector);
        KGGameTests.registerFunction(REFLECT_MIRRORS_ABOUT_THE_NORMAL, VectorNodeExtrasGameTest::reflectMirrorsAboutTheNormal);
        KGGameTests.registerFunction(ANGLE_BETWEEN_IS_UNSIGNED_AND_SAFE_AT_THE_ENDS, VectorNodeExtrasGameTest::angleBetweenIsUnsignedAndSafeAtTheEnds);
        KGGameTests.registerFunction(ROTATE_ABOUT_AXIS_IS_RIGHT_HANDED, VectorNodeExtrasGameTest::rotateAboutAxisIsRightHanded);
        KGGameTests.registerFunction(ROTATION_AND_DIRECTION_AGREE_WITH_THE_GAME, VectorNodeExtrasGameTest::rotationAndDirectionAgreeWithTheGame);
        KGGameTests.registerFunction(MOVE_TOWARDS_LANDS_EXACTLY_ON_THE_TARGET, VectorNodeExtrasGameTest::moveTowardsLandsExactlyOnTheTarget);
        KGGameTests.registerFunction(NEARLY_EQUALS_COMPARES_OVER_THE_WIDER_WIDTH, VectorNodeExtrasGameTest::nearlyEqualsComparesOverTheWiderWidth);
    }

    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        var data = KGGameTests.defaultTestData(environment, "empty");
        KGGameTests.registerFunctionTest(event, SWIZZLE_MASK_DECIDES_THE_OUTPUT_WIDTH, KGGameTests.functionKey(SWIZZLE_MASK_DECIDES_THE_OUTPUT_WIDTH), data);
        KGGameTests.registerFunctionTest(event, SWIZZLE_REFUSES_MASKS_IT_CANNOT_HONOUR, KGGameTests.functionKey(SWIZZLE_REFUSES_MASKS_IT_CANNOT_HONOUR), data);
        KGGameTests.registerFunctionTest(event, CONCAT_JOINS_IN_ORDER_AND_STOPS_AT_FOUR, KGGameTests.functionKey(CONCAT_JOINS_IN_ORDER_AND_STOPS_AT_FOUR), data);
        KGGameTests.registerFunctionTest(event, APPEND_WIDENS_BY_ONE_AND_STOPS_AT_FOUR, KGGameTests.functionKey(APPEND_WIDENS_BY_ONE_AND_STOPS_AT_FOUR), data);
        KGGameTests.registerFunctionTest(event, SET_COMPONENT_KEEPS_THE_INPUT_WIDTH, KGGameTests.functionKey(SET_COMPONENT_KEEPS_THE_INPUT_WIDTH), data);
        KGGameTests.registerFunctionTest(event, GET_COMPONENT_READS_BY_INDEX_AND_ZEROES_OUT_OF_RANGE, KGGameTests.functionKey(GET_COMPONENT_READS_BY_INDEX_AND_ZEROES_OUT_OF_RANGE), data);
        KGGameTests.registerFunctionTest(event, MULTIPLY_AND_DIVIDE_ACT_PER_COMPONENT, KGGameTests.functionKey(MULTIPLY_AND_DIVIDE_ACT_PER_COMPONENT), data);
        KGGameTests.registerFunctionTest(event, NEGATE_ABS_MIN_AND_MAX_ACT_PER_COMPONENT, KGGameTests.functionKey(NEGATE_ABS_MIN_AND_MAX_ACT_PER_COMPONENT), data);
        KGGameTests.registerFunctionTest(event, CLAMP_HOLDS_EVERY_COMPONENT_BETWEEN_THE_BOUNDS, KGGameTests.functionKey(CLAMP_HOLDS_EVERY_COMPONENT_BETWEEN_THE_BOUNDS), data);
        KGGameTests.registerFunctionTest(event, EVERY_ROUNDING_MODE_DIFFERS, KGGameTests.functionKey(EVERY_ROUNDING_MODE_DIFFERS), data);
        KGGameTests.registerFunctionTest(event, SQUARED_FORMS_COUNT_EVERY_COMPONENT, KGGameTests.functionKey(SQUARED_FORMS_COUNT_EVERY_COMPONENT), data);
        KGGameTests.registerFunctionTest(event, CLAMP_LENGTH_RESCALES_WITHOUT_TURNING, KGGameTests.functionKey(CLAMP_LENGTH_RESCALES_WITHOUT_TURNING), data);
        KGGameTests.registerFunctionTest(event, PROJECT_AND_REJECT_SPLIT_THE_VECTOR, KGGameTests.functionKey(PROJECT_AND_REJECT_SPLIT_THE_VECTOR), data);
        KGGameTests.registerFunctionTest(event, REFLECT_MIRRORS_ABOUT_THE_NORMAL, KGGameTests.functionKey(REFLECT_MIRRORS_ABOUT_THE_NORMAL), data);
        KGGameTests.registerFunctionTest(event, ANGLE_BETWEEN_IS_UNSIGNED_AND_SAFE_AT_THE_ENDS, KGGameTests.functionKey(ANGLE_BETWEEN_IS_UNSIGNED_AND_SAFE_AT_THE_ENDS), data);
        KGGameTests.registerFunctionTest(event, ROTATE_ABOUT_AXIS_IS_RIGHT_HANDED, KGGameTests.functionKey(ROTATE_ABOUT_AXIS_IS_RIGHT_HANDED), data);
        KGGameTests.registerFunctionTest(event, ROTATION_AND_DIRECTION_AGREE_WITH_THE_GAME, KGGameTests.functionKey(ROTATION_AND_DIRECTION_AGREE_WITH_THE_GAME), data);
        KGGameTests.registerFunctionTest(event, MOVE_TOWARDS_LANDS_EXACTLY_ON_THE_TARGET, KGGameTests.functionKey(MOVE_TOWARDS_LANDS_EXACTLY_ON_THE_TARGET), data);
        KGGameTests.registerFunctionTest(event, NEARLY_EQUALS_COMPARES_OVER_THE_WIDER_WIDTH, KGGameTests.functionKey(NEARLY_EQUALS_COMPARES_OVER_THE_WIDER_WIDTH), data);
    }
