...
public final class ShaderCompilerGameTest {
    ...
    private static final java.util.function.Function<RenderTypeGraph, ShaderGraphCompiler> STOCK = ShaderGraphCompiler::new;
    ...
    private static final java.util.function.Function<RenderTypeGraph, ShaderGraphCompiler> SEAMED = graph ->
    ...
    private static String transformFsh(java.util.function.Function<RenderTypeGraph, ShaderGraphCompiler> compiler,
