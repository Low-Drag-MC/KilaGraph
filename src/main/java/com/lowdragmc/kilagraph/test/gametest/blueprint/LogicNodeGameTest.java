...
public final class LogicNodeGameTest {
    ...
    private static final String EQ_NUMBERS = "logic_equals_numbers_by_value";
    private static final String EQ_THREE = "logic_equals_three_inputs";
    ...
    public static void registerFunctions() {
        ...
        KGGameTests.registerFunction(EQ_NUMBERS, LogicNodeGameTest::equalsComparesNumbersByValue);
        KGGameTests.registerFunction(EQ_THREE, LogicNodeGameTest::equalsAcrossThreeInputsAndNonNumbers);
    }
    ...
    public static void register(RegisterGameTestsEvent event, Holder<TestEnvironmentDefinition<?>> environment) {
        ...
        KGGameTests.registerFunctionTest(event, EQ_NUMBERS, KGGameTests.functionKey(EQ_NUMBERS), data);
        KGGameTests.registerFunctionTest(event, EQ_THREE, KGGameTests.functionKey(EQ_THREE), data);
    }
    ...
    /**
     * Equal numbers are equal however they arrived.
     *
     * <p>The mirror of the precision bug: {@code Objects.equals} asks the <em>wrapper</em>, so an
     * {@code Integer} 5 and a {@code Float} 5.0 came out unequal even though every player reading the
