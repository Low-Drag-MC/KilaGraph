...
public final class InfoNodeBenchGameTest {
    private static final String WHOLE_GRAPH_COST_OF_HAVING_ONE = "info_node_bench_whole_graph_cost_of_having_one";

    public static void registerFunctions() {
        KGGameTests.registerFunction(WHOLE_GRAPH_COST_OF_HAVING_ONE, InfoNodeBenchGameTest::wholeGraphCostOfHavingOne);
    }
