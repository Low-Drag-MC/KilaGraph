...
public final class IntrinsicParityGameTest {
    private static final String INTRINSICS_MATCH_THEIR_NODES_WHEN_WIRED = "intrinsic_parity_intrinsics_match_their_nodes_when_wired";
    private static final String INTRINSICS_MATCH_THEIR_NODES_WHEN_CONSTANT = "intrinsic_parity_intrinsics_match_their_nodes_when_constant";
    private static final String INTRINSICS_MATCH_THEIR_NODES_ON_DEFAULTED_INPUTS = "intrinsic_parity_intrinsics_match_their_nodes_on_defaulted_inputs";
    private static final String EVERY_INTRINSIC_IS_COVERED = "intrinsic_parity_every_intrinsic_is_covered";
    private static final String EVERY_EXEC_INTRINSIC_IS_COVERED = "intrinsic_parity_every_exec_intrinsic_is_covered";
    private static final String INTRINSICS_MATCH_THEIR_NODES_ON_WHOLE_NUMBER_WIRES = "intrinsic_parity_intrinsics_match_their_nodes_on_whole_number_wires";

    private IntrinsicParityGameTest() {}


    public static void registerFunctions() {
        KGGameTests.registerFunction(INTRINSICS_MATCH_THEIR_NODES_WHEN_WIRED, IntrinsicParityGameTest::intrinsicsMatchTheirNodesWhenWired);
        KGGameTests.registerFunction(INTRINSICS_MATCH_THEIR_NODES_WHEN_CONSTANT, IntrinsicParityGameTest::intrinsicsMatchTheirNodesWhenConstant);
        KGGameTests.registerFunction(INTRINSICS_MATCH_THEIR_NODES_ON_DEFAULTED_INPUTS, IntrinsicParityGameTest::intrinsicsMatchTheirNodesOnDefaultedInputs);
        KGGameTests.registerFunction(EVERY_INTRINSIC_IS_COVERED, IntrinsicParityGameTest::everyIntrinsicIsCovered);
        KGGameTests.registerFunction(EVERY_EXEC_INTRINSIC_IS_COVERED, IntrinsicParityGameTest::everyExecIntrinsicIsCovered);
        KGGameTests.registerFunction(INTRINSICS_MATCH_THEIR_NODES_ON_WHOLE_NUMBER_WIRES, IntrinsicParityGameTest::intrinsicsMatchTheirNodesOnWholeNumberWires);
    }
